...
# 練習問題(30分)
* `/do`ページでは, 次のような処理を行う.
	* フォームに入力した文字が英数字の場合, `hello, (入力した文字列)さん!`と表示する.
...
## 結局のところ...
* mojoliciousを使っているならば, ｢getメソッドは送るデータがURLに付く｣, ｢postメソッドは送るデータがURLに付かない｣という, 単純な認識で構いません.

* 詳しい資料
    * [インターネット興隆の立役者「HTTP～前編」](http://www.atmarkit.co.jp/fnetwork/rensai/netpro01/netpro01.html)
    * [Webアーキテクチャ設計術：ITpro](http://itpro.nikkeibp.co.jp/article/COLUMN/20071119/287478/)
